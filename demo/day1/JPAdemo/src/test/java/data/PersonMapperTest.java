...
public class PersonMapperTest {
    ...
    public void testCreatePerson() {
        ...
        Person person = new Person("Henriksen", "Pelle", "Gammel landevej 22", "Sønder Dråby");
    ...
    public void testEditPerson() throws Exception {
        ...
        Person person = instance.createPerson(new Person("Uno", "Albert", "Someroad 1", "Anyplace"));
...
//     */
    ...
    public void testDeletePerson() throws Exception {
        ...
        Person p = instance.createPerson(new Person("Uno", "Prime", "Somewhere 1", "Anyplace"));
...
//     */
    ...
    public void testFindPerson() {
        Person p = instance.createPerson(new Person("Uno", "Primo", "Somepath2", "Nowhere"));
